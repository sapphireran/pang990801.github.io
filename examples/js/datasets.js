...
window.FOOT_DATA = {
  "catalog": {
    ...
    "year": 2020,
    "note": "Personal archive extracted from the 2020 GitHub Pages dashboard. Values are copied from the published chart scripts; they are not a newly collected clinical sample.",
    "datasets": [
      ...
      "female": {
        ...
        "stats": {
          ...
          "height_cm": {
            ...
            "stdev": 21.39634493576705
          },
          "shoe_last_cm": {
            "min": 10.08,
            "max": 24.21,
            "mean": 16.76145728643216,
            "stdev": 3.2996784947356437
          },
          "pearson_r": 0.9135161963675741,
          "ols": {
            "slope": 0.1408796575674912,
            "intercept": 0.29894012355375565,
            "rmse": 1.3389400908785263,
  ...
  "bmiFoot": {
    ...
    "ring_charts": {
      "thin_feet": {
        ...
        "highlighted": 50,
        "remainder": 180,
        "highlighted_share": 0.21739130434782608
      },
      "plump_feet": {
        "label_zh": "过胖脚占比",
        "highlighted": 435,
        "remainder": 2400,
        "highlighted_share": 0.15343915343915343
      }
    }
  },
  "growthRadar": {
